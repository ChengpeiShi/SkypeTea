...
<div id="contentcolumn">
    ...
    <FORM ACTION="/ECE658-project/addEmployee" METHOD="POST"> 
         Employee ID: &nbsp&nbsp&nbsp&nbsp  <INPUT TYPE="number" NAME="id">(Unique number required)<BR></BR>
             Employee Name:  <INPUT TYPE="TEXT" NAME="name"><BR></BR>
                Employee Dept: &nbsp<INPUT TYPE="TEXT" NAME="dept"><BR></BR>
                    Employee Age: &nbsp&nbsp <INPUT TYPE="number" NAME="age"><BR></BR>      
                        Employee Email:&nbsp <INPUT TYPE="TEXT" NAME="email"><BR></BR>
                            Employee Phone: <INPUT TYPE="TEXT" NAME="phone">(Country & Area code required)<BR></BR>
                                    Employee Status:<select name="status">
                                        <option value ="OnSite">On-Site</option>
                                        <option value ="OffSite">Off-Site</option>
                                        <option value ="Sick">Sick</option>
                                    </select> <BR></BR>
                                         Employee Skype: <INPUT TYPE="TEXT" NAME="skype"><BR></BR>
