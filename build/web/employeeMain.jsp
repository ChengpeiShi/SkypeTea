...
<div id="SkypeButton_Dropdown_wanfei.liu_1">
  <script type="text/javascript">
    Skype.ui({
      "name": "dropdown",
      "element": "SkypeButton_Dropdown_wanfei.liu_1",
      "participants": ["wanfei.liu"],
      "imageSize": 45
    });
  </script>
</div>

<a href="skype:shichengpei?call">Call this client</a>
 -->
            </ul>
           <!-- <li><b>Equipment</b></li>
            <ul>
